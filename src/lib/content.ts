...
export const copy = {
  zh: {
    ...
    gallery: {
      ...
      sessions: [
        ...
        },
        {
          date: "2026-09-03",
          title: "第五场",
          note: "报名二十二个。开场讲的是自媒体运营——内容怎么做成能持续带人进来的东西。之后各桌自己聊到十二点。",
          photos: [
            { src: "/photos/session-05-1", alt: "十点一刻，先到的人已经在靠窗那几张小桌坐下，窗外是达令港", width: 1600, height: 900 },
            { src: "/photos/session-05-2", alt: "从帘子这一侧看过去，两张桌子各坐了几个人，落地窗外是水", width: 1600, height: 900 },
            { src: "/photos/session-05-3", alt: "十点半前后，靠窗几桌都坐上了人，有人站在窗边讲话", width: 1600, height: 900 },
            { src: "/photos/session-05-4", alt: "另一个角度的同一片场地，桌子沿着落地窗一路排开", width: 1600, height: 900 },
            { src: "/photos/session-05-5", alt: "从柱子后面看过去，几张小桌都坐满了", width: 1600, height: 900 },
            { src: "/photos/session-05-6", alt: "靠窗一排小桌，桌上摆着咖啡杯和水杯", width: 1600, height: 900 },
            { src: "/photos/session-05-7", alt: "有人站在桌边说话，其余人围坐着听", width: 1600, height: 900 },
            { src: "/photos/session-05-8", alt: "十一点，几张桌子各自聊开，窗外是达令港", width: 1600, height: 900 },
          ],
        },
        {
          date: "2026-09-10",
          ...
          photos: [
            ...
            { src: "/photos/session-06-3", alt: "长桌从近处看过去，尽头是吧台的酒架", width: 1600, height: 2133 },
            { src: "/photos/session-06-4", alt: "长桌的另一个角度，柱子和落地窗，有人在说话", width: 1600, height: 2133 },
            { src: "/photos/session-06-5", alt: "吧台前站着聊的几个人", width: 1600, height: 2133 },
            { src: "/photos/session-06-6", alt: "靠窗的小桌，几个人围坐着，窗外是水", width: 1600, height: 2133 },
            { src: "/photos/session-06-7", alt: "吧台边站着聊天的几个人，酒架在头顶", width: 1600, height: 2133 },
            { src: "/photos/session-06-8", alt: "散场后一群人走在外面，身后是玻璃幕墙的大楼", width: 1600, height: 2133 },
            { src: "/photos/session-06-9", alt: "同一群人走在路上，去吃午饭", width: 1600, height: 2133 },
            { src: "/photos/session-06-10", alt: "一张小桌上三个人，其中一个正比划着说话", width: 1600, height: 2133 },
          ],
        },
        {
          date: "2026-09-17",
          title: "第七场",
          note: "搬到 Chatswood 之后的第一场，玻璃房，头顶是藤，窗外是街。报名二十个，签到十五个，还有两个讲了整场却忘了签到的。这一场是三个分享接一场 Q&A：一个做 GEO 的团队讲 AI 搜索时代只剩三五个推荐位，长尾流量没有了；一个做 AI 创业的讲 FDE，讲怎么用几百到几千刀的小项目一点点换来客户的信任；一位研究者讲企业里几百个 agent 该怎么管，这件事眼下谁都没有答案。Q&A 的三个问题：没有技术背景的人怎么进 AI；老板自己都会用 AI 了，为什么还要付钱请人做；一门连数字化都还没做的线下生意，从哪一步开始。",
          photos: [
            { src: "/photos/session-07-1", alt: "玻璃房里的长桌，头顶挂着藤，桌上是电脑、菜单和咖啡", width: 1600, height: 900 },
            { src: "/photos/session-07-2", alt: "从长桌另一头看过去，一排人沿着木头长凳坐开，窗外是街", width: 1600, height: 900 },
            { src: "/photos/session-07-3", alt: "有人站在桌边讲，其他人坐着听，玻璃墙外是对面的楼", width: 1600, height: 900 },
            { src: "/photos/session-07-4", alt: "靠玻璃墙的长凳上坐了一排人，窗外是龙舌兰", width: 1600, height: 900 },
            { src: "/photos/session-07-5", alt: "一个人站起来讲话，全桌的人都转过去看她", width: 1600, height: 900 },
    ...
    wharf: {
      ...
      // ── 回答机制（Stage 1）────────────────────────────────────────
      // 两栏，不是过滤。判错的两个方向代价不对称：错误地把一条真问题归到
      ...
      comingCta: "我这场来答",
      comingSession: "选一场",
      comingNote: "{names} 会来答这条",
      answerCta: "在这儿写答案",
      answerPlaceholder: "答具体一点最有用——你怎么做的、卡在哪、有没有反例。",
      answerSubmit: "发上去",
      imageCta: "配一张图",
      imageChosen: "换一张",
      ...
      closeSubmit: "结帖",
      outcomeLabel: "拿到了什么",
      outcomePlaceholder: "一句话：你最后拿到了什么？（可以空着）",
      thankLabel: "请谁一份薯条",
      thankNobody: "不指定",
      // 薯条是收据，不是货币：挂在那一条回答上，不汇总成个人总分、不排序、
      // 不上成员卡、不能兑换。这条 2026-08-27 定过。
      // 记号是画出来的（ChipMark），所以这句里不要再放一个 🍟，否则一行两个。
      thanked: "{asker} 请了 {helper} 一份薯条",
      outcomeShown: "结果：{text}",
      answeredBy: "{name} 答的",
      working: "……",
      failed: "没成功，再试一次",
      signedOutNote: "认领过名片才能接问题和回答。",
      signInCta: "认领我的名片",
      copyLink: "复制这条的链接",
    ...
    feedback: {
      ...
      eyebrow: "§ 说两句",
      title: "今天这一场，你觉得怎么样？",
      lede: "六格，都能跳过，一分钟。匿名的——除非你自己在最后写下名字或微信号。",
      ...
      wechatLabel: "微信号（选填）",
      wechatHint: "只在需要回你的时候用。填了名字但没留联系方式，我就回不了。",
      submit: "交上去",
      doneTitle: "收到了，谢谢。",
    ...
    changelog: {
      ...
      eyebrow: "§ 更新记录",
      title: "这个活动也有版本号。",
      lede: "它一直在改。换过形式、换过场地、加过东西——下面是每一次改动，最新的在最上面。",
      current: "当前版本",
      major: "大版本",
      minor: "小更新",
      ...
      room: "现场",
      site: "网站",
      scopeNote: "记的是活动本身，所以两边都在这儿：现场怎么跑变了什么，网站上多了什么。前者多数一行代码都没改过——它们来自每一场的跑单和复盘。",
      footerLink: "更新记录",
  ...
  en: {
    ...
    gallery: {
      ...
      sessions: [
        ...
        },
        {
          date: "2026-09-03",
          title: "Session five",
          note: "22 signed up. The opening talk was on building an audience — how to make content that keeps bringing people in. After that each table carried on by itself until noon.",
          photos: [
            { src: "/photos/session-05-1", alt: "Quarter past ten, the early arrivals already seated at the small tables by the windows, Darling Harbour outside", width: 1600, height: 900 },
            { src: "/photos/session-05-2", alt: "Past the curtain, two tables with a few people at each, water through the glass", width: 1600, height: 900 },
            { src: "/photos/session-05-3", alt: "Around half past ten, the tables by the windows full, someone standing at the glass talking", width: 1600, height: 900 },
            { src: "/photos/session-05-4", alt: "Another angle on the same room, tables running the length of the windows", width: 1600, height: 900 },
            { src: "/photos/session-05-5", alt: "Looking past the column, every small table taken", width: 1600, height: 900 },
            { src: "/photos/session-05-6", alt: "The row of small tables by the windows, coffee cups and glasses on them", width: 1600, height: 900 },
            { src: "/photos/session-05-7", alt: "Someone standing at a table talking, the rest sitting around listening", width: 1600, height: 900 },
            { src: "/photos/session-05-8", alt: "Eleven o'clock, each table deep in its own conversation, Darling Harbour outside", width: 1600, height: 900 },
          ],
        },
        {
          date: "2026-09-10",
          ...
          photos: [
            ...
            { src: "/photos/session-06-3", alt: "The long table from close up, the bar's bottle shelves at the far end", width: 1600, height: 2133 },
            { src: "/photos/session-06-4", alt: "Another angle on the long table, columns and floor-to-ceiling glass, someone talking", width: 1600, height: 2133 },
            { src: "/photos/session-06-5", alt: "A few people standing at the bar, talking", width: 1600, height: 2133 },
            { src: "/photos/session-06-6", alt: "A small table by the windows, a few people around it, water outside", width: 1600, height: 2133 },
            { src: "/photos/session-06-7", alt: "People standing by the bar in conversation, the bottle shelves overhead", width: 1600, height: 2133 },
            { src: "/photos/session-06-8", alt: "After it ended, a group walking outside, a glass-fronted building behind them", width: 1600, height: 2133 },
            { src: "/photos/session-06-9", alt: "The same group on the way to lunch", width: 1600, height: 2133 },
            { src: "/photos/session-06-10", alt: "Three people at a small table, one of them mid-gesture", width: 1600, height: 2133 },
          ],
        },
        {
          date: "2026-09-17",
          title: "Session seven",
          note: "First one since the move to Chatswood: a glass room, vines overhead, the street outside. 20 signed up, 15 checked in, plus two who talked for the whole morning and forgot to. Three talks and then a Q&A. A team doing GEO on what changes when AI search leaves only three to five recommendation slots and the long tail disappears; an AI startup founder on FDE, and on earning a client's trust one small project at a time, a few hundred to a few thousand dollars each; a researcher on how a company is supposed to manage a few hundred agents, which nobody has an answer to yet. The Q&A's three questions: how someone without a technical background gets into AI; why a boss who already uses AI would pay someone else to build with it; and where a bricks-and-mortar business that has not even gone digital should start.",
          photos: [
            { src: "/photos/session-07-1", alt: "The long table in the glass room, vines overhead, laptops, menus and coffee on the table", width: 1600, height: 900 },
            { src: "/photos/session-07-2", alt: "From the far end of the long table, a row of people along the wooden bench, the street outside", width: 1600, height: 900 },
            { src: "/photos/session-07-3", alt: "Someone standing at the table talking, the rest seated and listening, the building across the road through the glass", width: 1600, height: 900 },
    ...
    wharf: {
      ...
      comingCta: "I'll be there for this",
      comingSession: "Which Thursday",
      comingNote: "{names} will be there for this one",
      answerCta: "Answer here",
      answerPlaceholder: "The specific version helps most — what you did, where it broke, what did not work.",
      answerSubmit: "Post it",
      ...
      outcomeLabel: "What you got",
      outcomePlaceholder: "One line: what did you end up with? (Optional)",
      thankLabel: "Buy someone chips",
      thankNobody: "Nobody in particular",
      thanked: "{asker} bought {helper} a serve of chips",
      outcomeShown: "Outcome: {text}",
      answeredBy: "{name} answered",
      working: "…",
      failed: "That did not go through — try again",
      signedOutNote: "Claim your card to take a question or answer one.",
      signInCta: "Claim my card",
      copyLink: "Copy a link to this one",
    ...
    feedback: {
      ...
      lede: "Six boxes, all skippable, about a minute. Anonymous — unless you put your name or WeChat ID in the last two.",
      ...
      wechatHint: "Only used if there is something to reply to. A name with no way to reach you cannot be answered.",
      submit: "Send it",
    ...
    changelog: {
      ...
      room: "In the room",
      site: "On the site",
      scopeNote: "This tracks the meetup, so both halves are here: what changed about how the morning runs, and what the site grew. Most of the first kind never touched a line of code \u2014 they come from the run sheet and the retro kept after each session.",
